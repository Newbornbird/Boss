        ...
        <div className="boss-table__cell">
          ...
          <div className="boss-table__cell">
            <div className="boss-table__info">
              ...
              <p className="boss-table__text"><a href="#" className="boss-table__link">Brian Smith</a></p>
            </div>
          </div>
          <div className="boss-table__cell">
            <div className="boss-table__info">
          ...
          <div className="boss-table__cell">
              <div className="boss-table__info">
                  ...
                  <p className="boss-table__text"><a href="#" className="boss-table__link">Brooklyn Mixer</a></p>
              </div>
          </div>
          <div className="boss-table__cell">
              <div className="boss-table__info">
